...
func _process(delta):
	if visible:
		$Panel/VBox/ColorSelector/Red.hint_tooltip = str($Panel/VBox/ColorSelector/Red.value)
		$Panel/VBox/ColorSelector/Green.hint_tooltip = str($Panel/VBox/ColorSelector/Green.value)
		$Panel/VBox/ColorSelector/Blue.hint_tooltip = str($Panel/VBox/ColorSelector/Blue.value)
